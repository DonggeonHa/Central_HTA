...
<div class="container">
	...
	<main class="mb-3">
		...
		<div class="row mb-2">
			<div class="col-6">
				<a href="modify?no=${board.no }&page=${param.page }" class="btn btn-outline-warning">수정</a>
				<a href="delete?no=${board.no }&page=${param.page }" class="btn btn-outline-danger">삭제</a>
			</div>
			<div class="col-6 text-right">
				<a href="list?page=${param.page }" class="btn btn-outline-primary">목록</a>
			</div>
		</div>
	</main>
</div>
