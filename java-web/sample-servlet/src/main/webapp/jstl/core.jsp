...
<%--
	JSTL 태그 라이브러리 중 core 태그 라이브러리를 JSP페이지에 포함시키기
 --%>
...
<html lang="ko">
	...
	<div class="container">
		<div class="row mb-3">
			<div class="col-12">
				<h3>out 태그</h3>
				<div>EL 표현식으로 출력 : ${text1 }</div>
				<div>out 태그로 출력 : <c:out value="${text1 }"/></div>
				
				<div>EL 표현식으로 출력 : ${text2 }</div>
				<div>out 태그로 출력 : <c:out value="${text2 }" escapeXml="false" /></div>
				<div>out 태그로 출력 : <c:out value="${text2 }" /></div>
			</div>
		</div>
		<div class="row mb-3">
			<div class="col-12">
				...
				<c:if test="${not empty names}">
					<p>names로 찾은 ArrayList는 비어있지 않다.</p>
				</c:if>
		...
		<div class="row mb-3">
			<div class="col-6">
				...
				<h4>String이 여러 개 저장된 List객체의 값 표현</h4>
				<ul>
			...
			<div class="col-6">
				<h4>Score 객체가 여러 개 저장된 List객체의 값 표현</h4>
				<table class="table">
					<thead>
						<tr>
							<th>순번</th>
		...
		<div class="row mb-3">
			<div class="col-12">
				...
				<c:set target="${king }" property="kor" value="90" /> 
				<c:set target="${king }" property="eng" value="90" /> 
				<c:set target="${king }" property="math" value="90" /> 
