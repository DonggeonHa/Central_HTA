...
<div class="container">
	...
	<main class="mb-3">
		...
		<div class="row">
			<div class="col-12">
				<form class="border bg-light px-3 py-2" method="post" action="modify">
					<input type="hidden" name="no" value="${board.no }">
					<input type="hidden" name="page" value="${param.page }">
					<c:if test="${not empty param.opt and not empty param.keyword }">
					...
					<div class="text-right">
						<a href="detail?${pageContext.request.queryString }" class="btn btn-secondary">취소</a>
