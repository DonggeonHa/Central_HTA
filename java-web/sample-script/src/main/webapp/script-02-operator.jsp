...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			console.log("5 != 5", 5 != 5);			// false	값이 같아서 false
			console.log("5 != '5'", 5 != '5');		// false	타입이 다르지만 변환 후 값이 같아서 false
			console.log("5 != 8", 5 != 8);			// true		값이 달라서 true
			console.log("5 != '8'", 5 != '8');		// true		값도 다르고 타입도 달라서 true
