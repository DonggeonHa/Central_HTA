...
<html>
	...
	<body>
        ...
        <div id="text-box">
        	...
        	<div id="text-box-3">세번째 글 박스입니다</div>
        </div>
        <div id="btn-box">
        	<!-- 
        		사용자가 버튼을 클릭했을 떄 사용자와 상호작용하기 위해서 onclick 이벤트를 사용함.
        		해당 엘리먼트에서 onclick 이벤트가 발생하면 실행될 이벤트핸들러 함수를 바인딩시킨다.
        	 -->
        ...
        <script type="text/javascript">
        	...
        	function secondEventHandler() {
        		// 아이디가 "text-box-2" 엘리먼트의 텍스트 컨텐츠를 다른 내용으로 변경하기
        		// 1. HTML Docoument객체에서 아이디가 "text-box-2"인 엘리먼트를 찾기
        	...
        	function thirdEventHandler() {
        		...
        		// 1. HTML Docoument객체에서 아이디가 "text-box-3"인 엘리먼트를 찾기
