	...
	<body>
		...
		<div>
			<!-- 
				...
				----------------------------------------------------------------------------------------
				id			모든 엘리먼트	스타일적용 및 자바스크립트 엘러먼트 검색용	불가
				class		모든 엘리먼트	스타일적용									가능
				name		form입력요소	폼입력값을 서버로 전송할 떄 값의 이름		가능
				----------------------------------------------------------------------------------------
			 -->
			 <input type="text" id="user-id" name="userid" onkeydown="handler1(event)" onkeypress="handler2()" onkeyup="handler3()"/>
		</div>
		<script type="text/javascript">
			...
			function handler3() {
				...
				// onkeyup 이벤트발생때만 폼에 새로 입력된 값을 읽어올 수 있다.
			}			
