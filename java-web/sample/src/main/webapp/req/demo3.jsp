...
<html>
	<head>
		<meta charset="UTF-8">
		<title>GET방식으로 요청파라미터 전송하기</title>
	</head>
	<body>
		<h1>GET방식으로 요청파라미터 보내기</h1>
		<p>
			클라이언트가 서버로 보내는 요청파라미터값을 요청URL의 끝에 ? 다음에 추가하는 것이다
			요청 URL 끝에 ?를 추가하고 그 뒤에 파라미터값을 추가할 수 있는데 이것을 Query String이라고 한다.
		</p>
		...
		<ul>
			...
			<li><a href="demo3-2.jsp?category=movie&no=4300">스타워츠</a></li>
		</ul>
		
		<h3>demo3-3.jsp에 여러 개의 요청파라미터값을 전달하기</h3>
