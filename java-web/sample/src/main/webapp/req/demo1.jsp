...
<html>
	...
	<body>
		...
		<%
			...
			// 요청 URI 조회하기
			// URL(Uniform Resurce Locator) : 자원의 위치
			// URI(Uniform Resurce Indentifier) : 자원에 대한 식별자
			...
			// 컨텍스트 경로 
			// - 웹어플리케이션 프로젝트를 구분할 때 사용하는 경로
			// - 지정하지 않으면 프로젝트명이 컨텍스트로 지정됌.
