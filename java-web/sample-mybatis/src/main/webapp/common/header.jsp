...
<%
	...
	// 사용자 인증과정을 통과한 클라이언트라면 세션객체에 "LOGINED_USER_INFO"라는 이름으로 저장된 객체를 찾을 수 있다.
	// loginedUser가 null이 아니면 사용자 인증과정을 통과한 사용자다.
	// loginedUser가 null이면 사용자 인증과정을 수행하지 않았거나, 인증과정을 통과하지 못한 경우다.
