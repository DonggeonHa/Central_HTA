...
<html lang="ko">
	...
	<body>
		...
		<%
			...
			// SAMPLE_PRODUCT_REVIEWS 테이블에 대한 CRUD 기능이 구현된 ReviewDao객체 획득하기
				...
				<div class="row mb-3">
					<div class="col-12">
						<table class="table table-bordered">
							...
							<tr>
								<th class="bg-light">상품번호</th><td><%=productNo%></td>
						...
						%>
								<li class="list-group-item">
									<div class="d-flex w-100 justify-content-between">
										...
										<%
											if (loginedUser != null && loginedUser.getId().equals(review.getUserId())) {
										%>
												<a href="deletereview.jsp?reivewNo=<%=review.getNo()%>&productNo=<%=productNo%>&page=<%=pageNo%>" class="btn btn-outline-danger btn-sm">삭제</a>
										<%
											}
										%>
									</div>
