...
<html lang="ko">
	...
	<body>
		<div class="container">
			...
			<main>
				<div class="row mb-3"> <!-- mb-3는 아래쪽 여백을 3만큼 설정한다 -->
					<div class="col-12">
				...
				<div class="row">
					<div class="col-12">
						<form method="post" action="add.jsp" class="border p-3 bg-light">
							...
							<div class="form-group">
								<label>가격</label>
								<input type="number" class="form-control" name="price" value="10000" min="5000" step="1000"/>
							</div>
							<div>
								<a href="list/jsp" class="btn btn-secondary">청소</a>
